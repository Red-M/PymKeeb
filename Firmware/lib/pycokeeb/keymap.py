...
class KeyMap(PinConfig):
    ...
    def load_keymap(self):
        self.keymap = [[
            ...
            [Keycode.GRAVE_ACCENT, Keycode.ONE, Keycode.TWO, Keycode.THREE, Keycode.FOUR, Keycode.FIVE, Keycode.SIX, Keycode.SEVEN, Keycode.EIGHT, Keycode.NINE, Keycode.ZERO, Keycode.MINUS, Keycode.EQUALS, Keycode.BACKSPACE, Keycode.INSERT, Keycode.HOME, Keycode.PAGE_UP, [KeyTypes.FUNC,meta_key_enum.function], Keycode.KEYPAD_FORWARD_SLASH, Keycode.KEYPAD_ASTERISK, Keycode.KEYPAD_MINUS],
            ...
            [Keycode.LEFT_CONTROL, Keycode.GUI, Keycode.LEFT_ALT, Keycode.SPACE, Keycode.RIGHT_ALT, Keycode.APPLICATION, [KeyTypes.FUNC,meta_key_enum.function], Keycode.RIGHT_CONTROL, None, None, None, None, None, Keycode.UP_ARROW, Keycode.KEYPAD_ONE, Keycode.KEYPAD_TWO, Keycode.KEYPAD_THREE, None, None, None, None],
